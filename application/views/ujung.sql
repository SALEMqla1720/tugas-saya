CREATE DATABASE IF NOT EXISTS `ujung`;
USE `ujung`;
...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 01 Mar 2020 pada 01.46
...
INSERT INTO `t_model` (`kd_model`, `nama_model`, `deskripsi`, `kd_stock_last`) VALUES
...
('KSX', 'Kimi XL', 'Kaos kaki untuk anak (>10 tahun)', 0);
...
(1, 'Justin Xavier', 'admin_kantor', '43045f34228734321398d5f04ac595b8', 'Jalan Dipatiukur', 'Bandung', '40000', '(022) - xxxxx', 'xxx@yyy.com', 1, 'Product Development Manager'),
(2, 'Mirana', 'admin_pabrik', 'e2336778d01b115657df7bdd7cae2444', 'Jalan xxx', 'Bandung', '40000', '022-xxx', 'xxx@zzz.com', 2, 'Kepala Gudang'),
(4, 'Admin', 'admin', '21232f297a57a5a743894a0e4a801fc3', 'dago', 'bandung', '54321', '0811234567890', 'anon@mail.com', 1, 'Product Development Manager');
