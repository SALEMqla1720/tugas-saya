...
$(".bs-example-modal-sm in-
put[name='kd_model']").attr("readonly", true);
...
$(".bs-example-modal-sm in-
put[name='kd_model']").val(null).attr("readonly", false);

$(".bs-example-modal-sm tex-
tarea[name='deskripsi']").html(null);
...
$(".bs-example-modal-sm in-
put[name='kd_model']").val(data.item.kd_model).attr("readonly", true);

$(".bs-example-modal-sm in-
put[name='nama_model']").val(data.item.nama_model);

$(".bs-example-modal-sm in-
put[name='jml_produk']").val(data.item.jml_produk);

$(".bs-example-modal-sm tex-
tarea[name='deskripsi']").html(data.item.deskripsi);

$('.bs-example-modal-sm').modal('show');

$(".bs-example-modal-sm in-
put[name='method']").val("edit");
